...
|ESP32 Expansion Board | To increase the number of available GPIO pins |
...
|Passive Buzzer | Produces audio alerts during repeated invalid authentication attempts after exceeding an amount of time, or door open escalation events|
